...
public class ModConfigScreen extends Screen {
    ...
    private void renderListScrollbar(GuiGraphicsExtractor guiGraphics) {
        int viewportHeight = listBottom - listTop;
        int contentHeight = rows.size() * ROW_HEIGHT;
    ...
    private static final class ConfigRow {
        ...
        private void renderLabel(GuiGraphicsExtractor guiGraphics, Font font) {
            guiGraphics.text(font, prettyName(field.getName()), x, y + 6, 0xFFFFFFFF, false);
        }
